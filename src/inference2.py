...
def main(cfg: DictConfig):
    ...
    lit_model = lit_model.load_from_checkpoint(r'C:\Users\ElifKübraÇontar\OneDrive - Surgease Innovations Ltd\Desktop\surgease-experimantal-setup\src\outputs\2022-07-26\20-19-36\checkpoints\overlap-epoch=14.ckpt', model=model, loss_fn=criterion)  # FILL IN THE CHECKPOINT PATH
    ...
    pd.DataFrame(y_pred_UCEIS).to_csv("predicted_2022-07-26-20-19-36-checkpoints-overlap-epoch=14.csv")
    pd.DataFrame(y_true_UCEIS).to_csv("groundtruth_2022-07-26-20-19-36-checkpoints-overlap-epoch=14.csv")
...
if __name__ == "__main__":
    ...
    y_pred_UCEIS = np.genfromtxt(r'C:\Users\ElifKübraÇontar\OneDrive - Surgease Innovations Ltd\Desktop\surgease-experimantal-setup\outputs\2022-08-04\12-19-04\predicted_2022-07-19-22-11-41-checkpoints-overlap-epoch=38.csv',delimiter=',',dtype=None)
    ...
    y_true_UCEIS = np.genfromtxt(r'C:\Users\ElifKübraÇontar\OneDrive - Surgease Innovations Ltd\Desktop\surgease-experimantal-setup\outputs\2022-08-04\12-19-04\groundtruth_2022-07-19-22-11-41-checkpoints-overlap-epoch=38.csv',delimiter=',',dtype=None)
